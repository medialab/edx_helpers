...
# endpoint = oembed.OEmbedEndpoint('http://www.scribd.com/services/oembed/', ['http://www.scribd.com/doc/*'])
# consumer.addEndpoint(endpoint)

# response = consumer.embed('http://www.scribd.com/doc/184457227/S03G08C02-example-STA-pdf')
